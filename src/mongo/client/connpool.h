...
public:
    ...
    void setOverloadConfig(const ConnectionPoolOverloadRuntime &config) {
        _overloadConfig = config;
    }
    ...
    /**
     * Returns the number of slow query connections
     */
    int numSlowQueries() const;
...
private:
    ...
    typedef std::map<long long, Date_t> CheckedOutMap;

    CheckedOutMap _checkedOutMap;

    ConnectionPoolOverloadRuntime _overloadConfig;
};
...
public:
    ...
    bool checkSlowQueries();

    void checkOverloadExpired();
    ...
    void setEnableOverload(bool enableOverload) {
        _overloadConfig.setEnableOverload(enableOverload);
    }

    void setOverloadResizing(bool enableResizing) {
        _overloadConfig.setOverloadResizing(enableResizing);
    }

    int getOverloadQueueSize() const {
        return _overloadConfig.getOverloadQueueSize();
    }

    void setOverloadQueueSize(int queueSize) {
        _overloadConfig.setOverloadQueueSize(queueSize);
    }

    int getNormalQueueSize() const {
        return _overloadConfig.getNormalQueueSize();
    }

    void setNormalQueueSize(int queueSize) {
        _overloadConfig.setNormalQueueSize(queueSize);
    }

    int getNormalInUsePoolSize() const {
        return _overloadConfig.getNormalInUsePoolSize();
    }
    ...
    void setNormalInUsePoolSize(int poolSize) {
        ...
        _overloadConfig.setNormalInUsePoolSize(poolSize);
    }

    int getOverloadInUsePoolSize() const {
        return _overloadConfig.getOverloadMaxInUsePoolSize();
    }

    void setOverloadInUsePoolSize(int poolSize) {
        _overloadConfig.setOverloadInUsePoolSize(poolSize);
    }
	...
	size_t getCheckedOutSize(const std::string& ident, double socketTimeout) const;
...
private:
    ...
    ConnectionPoolOverloadConfig _overloadConfig;
};
