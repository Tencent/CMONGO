...
MONGO_INITIALIZER(InitializeConnectionPools)(InitializerContext* context) {
    ...
    globalConnPool.setNormalInUsePoolSize(ConnPoolOptions::maxInUseConnsPerHost);
    ...
    shardConnectionPool.setNormalInUsePoolSize(ConnPoolOptions::maxShardedInUseConnsPerHost);
