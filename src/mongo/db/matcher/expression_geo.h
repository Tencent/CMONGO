...
public:
	...
	// $hintScan hints the maximun objects to scan in each circle
	int64_t hintScan;

	// $hintCorrectNum hints the num neareasts objs in each circle
    ...
    std::string toString() const {
		...
		ss << " hintScan=" << hintScan;
		ss << " hintCorrectNum=" << hintCorrectNum;
		ss << " geoLimitNum=" << geoLimitNum;
        return ss.str();
    }
