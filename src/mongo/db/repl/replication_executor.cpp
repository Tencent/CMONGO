...
Status ReplicationExecutor::updateConnPoolOptions(const mongo::executor::ConnectionPool::Options& o) {
	return Status(ErrorCodes::InternalError, "ReplicationExecutor::updateConnPoolOptions should not be called"); 
}

Status ReplicationExecutor::getConnPoolOptions(mongo::executor::ConnectionPool::Options& o) {
    return Status(ErrorCodes::InternalError, "ReplicationExecutor::getConnPoolOptions should not be called");
}
