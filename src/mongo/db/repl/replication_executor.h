...
public:
	...
	Status updateConnPoolOptions(const mongo::executor::ConnectionPool::Options&) override;

    Status getConnPoolOptions(mongo::executor::ConnectionPool::Options&) override;
