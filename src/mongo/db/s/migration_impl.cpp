...
Status ChunkMoveOperationState::commitMigration(const MigrationSessionId& sessionId) {
...

    {
        ...
        n.append(ChunkType::name(), ChunkDefault::genID(_nss.ns(), _minKey));
        ...
        q.append(ChunkType::name(), ChunkDefault::genID(_nss.ns(), _minKey));
        q.done();
    ...
    if (bumpedCollMetadata->getNumChunks() > 0) {
        ...
        BSONObjBuilder n(op.subobjStart("o"));
        n.append(ChunkType::name(), ChunkDefault::genID(_nss.ns(), bumpMin));
        ...
        BSONObjBuilder q(op.subobjStart("o2"));
        q.append(ChunkType::name(), ChunkDefault::genID(_nss.ns(), bumpMin));
        q.done();
