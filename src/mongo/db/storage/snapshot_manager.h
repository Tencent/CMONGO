...
public:
    ...
    virtual Status setOplogTimeOfSnapshot(const SnapshotName& name, Timestamp ts) = 0;
    /**
    ...
    virtual void setNonBlockReadSnapshot(OperationContext* txn, const SnapshotName& name) = 0;
