...
public:
    ...
    Status setReadFromNonBlockReadSnapshot() final;

    bool isReadingFromNonBlockReadSnapshot() const final {
        return _readFromNonBlockReadSnapshot;
    }

    boost::optional<SnapshotName> getNonBlockReadSnaoshot() const final;


    void dropNonBlockSnaphsot() final;
...
private:
    ...
    bool _readFromNonBlockReadSnapshot = false;
