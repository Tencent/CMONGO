...
public:
    ...
    struct Options {
        ...
        ConnectionPoolOverloadConfig overloadConfig;
    };
	...
	Status updateConnPoolOptions(const Options& options);

    Status getConnPoolOptions(Options& options);
...
private:
    ...
    void checkSlowQueries(const stdx::unique_lock<stdx::mutex>& lk);
...
private:
    ...
    virtual void indicateStarted() = 0;
