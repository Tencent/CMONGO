...
public:
	...
	virtual Status updateConnPoolOptions(const executor::ConnectionPool::Options& options) = 0;

    virtual Status getConnPoolOptions(executor::ConnectionPool::Options& options) = 0;
