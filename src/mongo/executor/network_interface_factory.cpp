...
std::unique_ptr<NetworkInterface> makeNetworkInterface(std::string instanceName) {
    return makeNetworkInterface(std::move(instanceName),
			 nullptr,
			 nullptr,
...
std::unique_ptr<NetworkInterface> makeNetworkInterface(
	...
	size_t minConnPerHostPerWorker,
    size_t maxConnPerHostPerWorker) {
	...
	options.connectionPoolOptions.minConnections = minConnPerHostPerWorker;
	options.connectionPoolOptions.maxConnections = maxConnPerHostPerWorker;
