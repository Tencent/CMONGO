...
Status ThreadPoolTaskExecutor::updateConnPoolOptions(const executor::ConnectionPool::Options& options) {
	return _net->updateConnPoolOptions(options);
}

Status ThreadPoolTaskExecutor::getConnPoolOptions(executor::ConnectionPool::Options& options) {
    return _net->getConnPoolOptions(options);
}
