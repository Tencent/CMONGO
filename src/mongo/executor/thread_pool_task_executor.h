...
public:
	...
	Status updateConnPoolOptions(const executor::ConnectionPool::Options& options) override;
    Status getConnPoolOptions(executor::ConnectionPool::Options& options) override;
