...
Status CatalogManagerReplicaSet::shardCollection(OperationContext* txn,
    ...
    shared_ptr<ChunkManager> manager(new ChunkManagerDefault(ns, fieldsAndOrder, unique));
    ...
    CollectionInfoDefault collInfo;
...
Status CatalogManagerReplicaSet::updateShards(OperationContext *txn) {
    log() << "update shards list in CatalogManagerReplicaSet";
    return Status::OK();
}
