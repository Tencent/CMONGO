...
TEST_F(ShardCollectionTest, noInitialChunksOrData) {
    ...
    expectedChunk.setName(ChunkDefault::genID(ns, keyPattern.getKeyPattern().globalMin()));
...
TEST_F(ShardCollectionTest, withInitialChunks) {
    ...
    expectedChunk0.setName(ChunkDefault::genID(ns, expectedChunk0.getMin()));
    ...
    expectedChunk1.setName(ChunkDefault::genID(ns, expectedChunk1.getMin()));
    ...
    expectedChunk2.setName(ChunkDefault::genID(ns, expectedChunk2.getMin()));
    ...
    expectedChunk3.setName(ChunkDefault::genID(ns, expectedChunk3.getMin()));
    ...
    expectedChunk4.setName(ChunkDefault::genID(ns, expectedChunk4.getMin()));
